...
# Condition of message to display.
...
# Set the active and urgent status of the playing track.
[ -n "$(joyd_music_controller status)" ] && P_A='1' || P_U='1'

# Set the active and urgent status of the MPD single-loop.
case "$MUSIC_PLAYER" in
...
# Display active and urgent status via rofi-specific escape sequences.
